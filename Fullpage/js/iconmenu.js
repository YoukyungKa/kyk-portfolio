$(function(){
	...
	$(".side_nav li:eq(0)").css({background:"gold"});
	$(".side_nav li a:eq(0)").css({color:"#gold"});
	...
	$(".side_nav li:eq(1)").click(function(){
		...
		$(".side_nav li").css({background:"#fff"});
		$(".side_nav li a").css({color:"#000"});
		$(".side_nav li:eq(1)").css({background:"gold"});
	...
	$(".side_nav li:eq(2)").click(function(){
		...
		$(".side_nav li").css({background:"#fff"});
		$(".side_nav li a").css({color:"#000"});
		$(".side_nav li:eq(2)").css({background:"gold"});
	...
	$(".side_nav li:eq(3)").click(function(){
		...
		$(".side_nav li").css({background:"#fff"});
		$(".side_nav li a").css({color:"#000"});
		$(".side_nav li:eq(3)").css({background:"gold"});
	...
	$(".side_nav li:eq(4)").click(function(){
		...
		$(".side_nav li").css({background:"#fff"});
		$(".side_nav li a").css({color:"#000"});
		$(".side_nav li:eq(4)").css({background:"gold"});
	...
	$(".side_nav li:eq(5)").click(function(){
		...
		$(".side_nav li").css({background:"#fff"});
		$(".side_nav li a").css({color:"#000"});
		$(".side_nav li:eq(5)").css({background:"gold"});
